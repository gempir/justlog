...
This project is no longer maintained. I recommend the excellent project rustlog which has a compatible API, is more efficient and stores logs in ClickHouse.

https://github.com/boring-nick/rustlog
