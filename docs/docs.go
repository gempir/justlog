...
// 2020-02-11 18:48:21.740064 +0100 CET m=+0.118801301
...
var doc = `{
    ...
    "paths": {
        ...
        "/{channelIdType}/{channel}/{userIdType}/{username}/{year}/{month}": {
            "get": {
                "produces": [
                    "application/json",
                    "text/plain"
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "channelid or channel",
                        "name": "channelIdType",
                        "in": "path",
                        "required": true
                    },
